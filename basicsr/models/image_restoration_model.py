...
class ImageRestorationModel(BaseModel):
    ...
    def dist_validation(self, dataloader, current_iter, tb_logger, save_img, rgb2bgr, use_image):
        ...
        with_metrics = None#self.opt['val'].get('metrics') is not None
        if with_metrics:
            self.metric_results = {
                metric: 0
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            img_name = val_data['lq_path'][0]#osp.splitext(osp.basename(val_data['lq_path'][0]))[0]
            ...
            #     del self.gt
            timer.append([i, time.time()-start, img_name])
            i += 1
