...
```
python Foreground.py --nn=0 --somepath='D:/Studia/Magisterskie/Magisterka/programy/Scale-recurrent Network for Deep Image Deblurring/SRN-Deblur/matibgz.jpg' --model=color --height=720 --width=1280
