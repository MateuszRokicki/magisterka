...
#     parser.add_argument('--somepath', type=str, default='test', help='determine whether train or test')
#     parser.add_argument('--nn', type=str, default='test', help='determine whether train or test')
...
#     h= shape[0]
#     w= 1280#shape[1]
#     #deblur.test(args.height, args.width, path)
#     return(deblur.test(h, w))
#     # if args.phase == 'test':
#     # elif args.phase == 'train':
#     #     deblur.train()
#     # else:
